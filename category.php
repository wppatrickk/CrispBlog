<?php get_header() ?>
	...
	<div id="content-wrap" class="<?php echo get_theme_mod('crispblog_archive_layout', 'full_width'); ?>">
		...
		<div id="content">
			...
			<?php $category_post_layout = get_theme_mod('crispblog_category_layout', 'category_grid');
			if ($category_post_layout == 'category_standard') { ?>
				<ul class="blog-posts">
			...
			<?php } elseif ($category_post_layout == 'category_grid') { ?>
			...
			<?php } elseif ($category_post_layout == 'category_textless') { ?>
			...
			<?php } elseif ($category_post_layout == 'category_infinite') { ?>
